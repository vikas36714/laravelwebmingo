...
class ContentsController extends Controller
{
    ...
    public function about()
    {
        ...
        if(empty($about)){
            ...
            $about = json_decode(json_encode($arr));
        }
    ...
    public function termsAndConditions()
    {
        ...
        if(empty($termConditions)){
            ...
            $termConditions = json_decode(json_encode($arr));
        }
    ...
    public function privacyPolicy()
    {
        ...
        if(empty($privacyPolicies)){
            ...
            $privacyPolicies = json_decode(json_encode($arr));
        }
    ...
    public function refundAndCancellation()
    {
        ...
        if(empty($refundCancellations)){
            ...
            $refundCancellations = json_decode(json_encode($arr));
        }
    ...
    public function updateRefundAndCancellation(Request $request, $id)
    {
        ...
        if(empty($refundCancellation)){
            $refundCancellation = new RefundCancellation;
        }
        if($request->hasFile('image') == null){
