                  ...
                  <table class="table table-bordered table-fitems forall">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><span class="badge badge-success">Confimed</span></td>
                        <td>12.10.2020 12:00PM</td>
                        <td>
                          <ul class="action">
                            <li><a href="#" title="Edit Lead"><i class="fas fa-pencil-alt"></i></a></li>
                          <li><a href="{{route('admin.lead-status')}}" title="Lead Status"><i class="fas fa-history"></i></a></li>
